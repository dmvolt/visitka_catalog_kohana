						...
						<div class="media blog-entry">
							...
							<div class="media-body">
								<div class="blog-entry-content">
									...
									<h2><a href="<?= Data::_('lang_uri') ?>/news/<?= $value['alias'] ?>"><?= $value['descriptions'][Data::_('lang_id')]['title'] ?></a></h2>
									...
									<div class="content">
										...
										<a href="<?= Data::_('lang_uri') ?>/news/<?= $value['alias'] ?>"><?= $text_read_more ?> <span class="fa fa-long-arrow-right"></span></a>
									</div>
								</div>
							</div>
						</div>
