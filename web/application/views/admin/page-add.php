...
<h2 class="title"><?= $text_add_new_content2 ?></h2>
...
<div id="tabs">
	...
	<div id="tabs-1">
        ...
        <div class="form_item" style="top:35px">
            <label for="status"><?= $text_status ?></label><input type="checkbox" id="status" name="status" checked="checked" value="1">
        </div>
		
		<div class="form_item" style="top:35px">
            <label for="in_front"><?= $text_in_front ?></label><input type="checkbox" id="in_front" name="in_front" checked="checked" value="1">
        </div>
	</div>
