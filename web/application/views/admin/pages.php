...
<h2 class="title"><?= $text_contents ?> <a href="/admin/pages/add" title="<?= $text_add_new_content ?>"><img src="/images/admin/add.png" style="margin-bottom:-10px;"></a></h2>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <td><strong><?= $text_page_thead_name ?></strong><br><a onclick="$('#weight_form').submit();" class="btn_core btn_core_blue btn_core_sm"><span><?= $text_save ?></span></a></td>
                    <td><strong><?= $text_page_thead_alias ?></strong><br><a onclick="$('#weight_form').submit();" class="btn_core btn_core_blue btn_core_sm"><span><?= $text_save ?></span></a></td>
                    <td class="last"><strong><?= $text_page_thead_status ?></strong><br><a onclick="$('#weight_form').submit();" class="btn_core btn_core_blue btn_core_sm"><span><?= $text_save ?></span></a></td>
                    ...
                    <td class="last"><strong><?= $text_page_thead_action ?></strong></td>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($contents as $key => $value): ?>
                    <tr>
                        ...
                        <td class="last"><a href="/admin/pages/edit/<?= $value['id'] ?>" class="edit"><?= $text_edit ?></a>&nbsp;&nbsp;<a href="/admin/pages/delete/<?= $value['id'] ?>" class="delete"><?= $text_delete_img ?></a></td>
                    </tr>
                <?php endforeach; ?> 
            </tbody>
        </table>
