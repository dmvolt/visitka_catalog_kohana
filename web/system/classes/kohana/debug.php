...
class Kohana_Debug {
	...
	public static function path($file)
	{
		...
		elseif (strpos($file, MODPATH_SYS) === 0)
		{
			$file = 'MODPATH_SYS'.DIRECTORY_SEPARATOR.substr($file, strlen(MODPATH_SYS));
		}
		elseif (strpos($file, MODPATH_PROJECT) === 0)
		{
			$file = 'MODPATH_PROJECT'.DIRECTORY_SEPARATOR.substr($file, strlen(MODPATH_PROJECT));
		}
