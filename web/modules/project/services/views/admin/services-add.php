...
<div id="tabs">
	...
	<div id="tabs-1">
		...
		<div class="form_item" style="top:35px">
			<label for="is_fine"><?= $text_services_is_fine ?></label><input type="checkbox" id="status" name="is_fine" value="1">
		</div>
		<div class="form_item" style="top:35px">
			<label for="status"><?= $text_services_status ?></label><input type="checkbox" id="status" name="status" checked="checked" value="1">
		</div>
	</div>
