<? if (isset($errors)) { ?>
    ...
    <? } ?>
<? } ?>
<?= Modulinfo::get_admin_block('projects') ?>
<h2 class="title"><?= $text_projects ?> <a href="/admin/projects/add<?= $parameters ?>" title="<?= $text_add_new_projects ?>"><img src="/images/admin/add.png" style="margin-bottom:-10px;"></a></h2>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <td><strong><?= $text_projects_thead_name ?></strong><br><a onclick="$('#weight_form').submit();" class="btn_core btn_core_blue btn_core_sm"><span><?= $text_save ?></span></a></td>
                    <td><strong><?= $text_projects_thead_alias ?></strong><br><a onclick="$('#weight_form').submit();" class="btn_core btn_core_blue btn_core_sm"><span><?= $text_save ?></span></a></td>
                    <td class="last"><strong><?= $text_projects_thead_status ?></strong><br><a onclick="$('#weight_form').submit();" class="btn_core btn_core_blue btn_core_sm"><span><?= $text_save ?></span></a></td>
                    ...
                    <td class="last"><strong><?= $text_projects_thead_action ?></strong></td>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($contents as $key => $value): ?>
                    <tr>
                        ...
                        <td class="last"><a href="/admin/projects/edit/<?= $value['id'] ?><?= $parameters ?>" class="edit"><?= $text_edit ?></a>&nbsp;&nbsp;<a href="/admin/projects/delete/<?= $value['id'] ?><?= $parameters ?>" class="delete"><?= $text_delete_img ?></a></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>		
        </table>
