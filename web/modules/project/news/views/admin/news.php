<? if (isset($errors)) { ?>
    ...
    <? } ?>
<? } ?>
<?= Modulinfo::get_admin_block('news') ?>
        ...
        <table>
            <thead>
                <tr>
					...
					<td><strong><?= $text_news_thead_type ?></strong></td>
                    <td><strong><?= $text_news_thead_name ?></strong></td>
                    <td><strong><?= $text_news_thead_alias ?></strong></td>
                    <td class="last"><strong><?= $text_news_thead_status ?></strong><br><a onclick="$('#weight_form').submit();" class="btn_core btn_core_blue btn_core_sm"><span><?= $text_save ?></span></a></td>
            ...
            <tbody>
                <?php foreach ($contents as $key => $value): ?>
                    <tr>
						...
						<td>
							<?php if ($value['type']): ?>
								<span style="color:orange"><b>опрос</b></span><br>
								<?= News::poll_result($value['id'], $value['descriptions'][1]['poll']) ?>
							<?php else: ?>
								<span style="color:green"><b>новость</b></span>
							<?php endif; ?>
						</td>
                        <td class="first">
                        ...
                        <td class="last"><a href="/admin/news/edit/<?= $value['id'] ?>" class="edit"><?= $text_edit ?></a>&nbsp;&nbsp;<a href="/admin/news/delete/<?= $value['id'] ?>" class="delete"><?= $text_delete_img ?></a></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>		
        </table>
