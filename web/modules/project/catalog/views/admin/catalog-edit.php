...
<div id="tabs">
	...
	<div id="tabs-1">
		...
		<div class="form_item">
			...
			<input type="text" name="price1" value="<?= $content['price1'] ?>" class="text">
		</div>
		...
		<div class="form_item" style="top:35px">
			<label for="is_fine"><?= $text_catalog_is_fine ?></label>
			<?php if ($content['is_fine']): ?>
				<input type="checkbox" name="is_fine" checked="checked" value="1">
			<?php else: ?>
				<input type="checkbox" name="is_fine" value="1">
			<?php endif; ?>
		</div>
		<div class="form_item" style="top:35px">
			<label for="status"><?= $text_catalog_status ?></label>
