<? if (isset($errors)) { ?>
    ...
    <? } ?>
<? } ?>
<h2 class="title"><?= $text_add_new_catalog ?></h2>
...
<div id="tabs">
	...
	<div id="tabs-1">
		...
		<div class="form_item">
			<label for="price1">Стоимость</label></br>
			<input type="text" name="price1" value="<?= $post['price1'] ?>" class="text">
		</div>
		...
		<div class="form_item" style="top:35px">
			<label for="is_fine"><?= $text_catalog_is_fine ?></label><input type="checkbox" id="status" name="is_fine" value="1">
		</div>
		<div class="form_item" style="top:35px">
			<label for="status"><?= $text_catalog_status ?></label><input type="checkbox" id="status" name="status" checked="checked" value="1">
		</div>
	</div>
